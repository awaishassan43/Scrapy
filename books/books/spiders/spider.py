...
class SpiderSpider(scrapy.Spider):
    ...
    def parse_book(self, response):
        ...
        stars = response.xpath('//div/p[contains(@class, "star-rating")]/@class').extract_first().replace('star-rating','').strip()
        description = response.xpath('//div[contains(@id, "product_description")]/following-sibling::p/text()').extract_first()
